...
export default function User({ user }) {
  ...
  } else if (state.user.id === id || state.user.isAdmin === true) {
    idUser = (
        ...
        <Fragment>
          <div className="card">
            <div className="user-action">
              <i
                className="fas fa-user white fa-3x"
                onClick={() => {
              ...
              <i
                className="fas fa-envelope-open white fa-3x"
                onClick={() => {
              ...
              ></i>
              <i
                className="fas fa-portrait white fa-3x"
                onClick={() => {
              ...
              ></i>
              <i
                className="fas fa-user-slash white fa-3x"
                onClick={() => {
      ...
      <div className="detail">
        <div className="postTopRight">
          <h4 className="postDate">
            Compte Crée le :{" "}
            {user.createdAt.split("T").join(" à ").split(".000Z").join("")}
          </h4>
        </div>
